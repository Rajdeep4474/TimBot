        ...
        public List<String> OnMessage(String sInMessage)
        {
            ...
            switch (this.nCur)
            {
                case State.WELCOMING:
                    aMessages.Add("Welcome to TimBot");
                    aMessages.Add("We provide the following services:");
                    aMessages.Add("1. Order Placement");
                    aMessages.Add("2. Menu Information");
                    aMessages.Add("3. Location Finder");
                    aMessages.Add("4. General Information");
